...
import UsersNewUserForm from "./modalForms/usersNewUserForm";
...
class Modal extends React.Component {
  ...
  componentDidMount() {
    ...
    switch (type) {
      ...
      case MODAL_TYPES.USERS_NEW_USER:
        this.setModalTitle(t("User details"));
        break;
  ...
  componentWillReceiveProps(nextProps) {
    ...
    if (
      ...
      nextProps.params.type === MODAL_TYPES.UPLOADING_XLS
    ) {
  ...
  submissionTitle(props) {
    ...
    if (!p.isDuplicated) {
      ...
      if (p.tableInfo) {
        let index =
          p.ids.indexOf(sid) +
          p.tableInfo.pageSize * p.tableInfo.currentPage +
          1;
    ...
    return (
      ...
      >
        <ui.Modal.Body>
          ...
          {this.props.params.type === MODAL_TYPES.USERS_NEW_USER && (
            <UsersNewUserForm onSetModalTitle={this.setModalTitle} />
          )}
          {this.props.params.type === MODAL_TYPES.ASSET_TAGS && (
            <AssetTagsForm asset={this.props.params.asset} />
          )}
          {this.props.params.type === MODAL_TYPES.LIBRARY_UPLOAD && (
            <LibraryUploadForm onSetModalTitle={this.setModalTitle} />
          )}
          ...
          {this.props.params.type === MODAL_TYPES.ENKETO_PREVIEW &&
          ...
          {this.props.params.type === MODAL_TYPES.SUBMISSION &&
            this.state.sid && (
              <Submission
                sid={this.state.sid}
                asset={this.props.params.asset}
